        ...
        <div className="max-w-md mx-auto h-full flex flex-col">
          {selectionMode ? (
            <div className="space-y-8 animate-in fade-in duration-500 flex-1">
              ...
              <div className="pt-8 text-center mt-auto pb-4">
                <button
                  onClick={() => setIsRegistering(true)}
                  className="inline-flex flex-col items-center gap-2 group"
                >
                  <span className="text-[10px] font-black text-[#2e9782] uppercase tracking-[0.2em] group-hover:opacity-70 transition-all">New Supplier? Join The Network</span>
                  <div className="h-0.5 w-12 bg-[#2e9782]/20 group-hover:w-full transition-all duration-300"></div>
                </button>
              </div>
            </div>
          ) : (
            <div className="animate-in slide-in-from-right duration-500">
              ...
              <div className="mb-10 text-center">
                <h3 className="text-2xl font-black text-[#224194] tracking-tight mb-2">
                  {selectedRole === 'ADMIN' ? 'Admin Access' : selectedRole === 'AGENT' ? 'Agent Login' : 'Vendor Gateway'}
                </h3>
