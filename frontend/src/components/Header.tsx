...
const Header: React.FC<HeaderProps> = ({ user, onLogout, unreadCount = 0, onMarkAllRead, onNotificationClick }) => {
  return (
    <header className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-slate-100 z-40 px-4 pt-[calc(0.75rem+env(safe-area-inset-top))] pb-3 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="w-10 h-10 rounded-xl bg-slate-50 text-slate-500 hover:text-[#224194] hover:bg-blue-50 transition-all flex items-center justify-center relative"
        >
